...
class NghiepVuPage extends Model
{
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function getDSDonThu($diaBanIdAllArray)
    {
        $dsDonThu= DonThuTable::getTTDonThu($diaBanIdAllArray);
        return $dsDonThu;
    }
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function getDonViTheoDiaBan($diaBanSelect)
    {
        $result = DonViTable::getDonViTheoDiaBan($diaBanSelect);
        return $result;
    }
...
//        }
    ...
    {
        $result = DonThuTable::StoreDonThu($request,$lanhDaoID,$diabanId,$accountId,$donVi);
        return $result;
    }
    ...
    {
        DonThuTable::UpdateVanBanDinhKem($id,$request,$accountId);
    }
    ...
    {
        PhanLoaiDonThuTable::updateScanPhieuHuongDan($id,$request,$accountId);
    }
    ...
    {
        PhanLoaiDonThuTable::updateCongVanChuyenDon($id,$request,$accountId);
    }
    ...
    {
        PhanLoaiDonThuTable::updateThongBaoChuyenDon($id,$request,$accountId);
    }
    ...
    {
        PhanLoaiDonThuTable::updateVanBanYeuCauXuLy($id,$request,$accountId);
    }
    ...
    {
        TheoDoiDonThuTable::updateFilePhieuTrinh($id,$request,$accountId);
    }
    ...
    {
        TheoDoiDonThuTable::updateFileTBTL($id,$request,$accountId);
    }
...
//            }
    ...
    {
        $result = TheoDoiDonThuTable::updateTheoDoiDonThu($request,$accountId);
...
//        }
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetFullName($diabanId)
    {
        $name = DonThuTable::GetName($diabanId);
        return $name;
    }
    /**************************************************
...
//        die;
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetTongDonChuaGQ($diaBanIdAllArray,$loaidon)
    {
        $result = DonThuTable::DataTongDonChuaGQ($diaBanIdAllArray,$loaidon);
...
//                        if ($today >= $ngayketthuc && $ngayketthuc >= $date_xuly) {
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetDataXuLy($diaBanIdAll,$type,$loaidonId)
    {

        $result = DonThuTable::GetDonXuLy($diaBanIdAll,$type,$loaidonId);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetDataGiaiQuyet($diaBanIdAll,$type,$loaidonId)
    {
        $results = DonThuTable::GetDonGiaiQuyet($diaBanIdAll,$type,$loaidonId);
        return $results;
    }
    /**************************************************
	...
	/**************************************************
    Function Name	: exportSoTiepDan
    Description		: export So Tiep Dan
    Argument		: $tu_Ngay,$den_Ngay,$diaBanIdArray
    Creation Date	: 2016/08/01
    Author			: KhanhTH
    Reviewer		: PhucHM
     ***************************************************/
    public static function exportSoTiepDan($tu_Ngay,$den_Ngay,$diaBanIdArray)
    {
        $ketquatiepdan = KetQuaTiepDanTable::GetBaoCaoKetQuaTiepDanTheoDiaBan($tu_Ngay,$den_Ngay,$diaBanIdArray);
        $objWriter = MauSo::mauSoTiepDan($ketquatiepdan);
        return $objWriter;
    }

    /**************************************************
    Function Name	: exportSoKhieuNaiToCao
    Description		: export So Khieu Nai To Cao
    Argument		: $tu_Ngay,$den_Ngay,$diaBanIdArray
    Creation Date	: 2016/08/01
    Author			: KhanhTH
    Reviewer		: PhucHM
     ***************************************************/
    public static function exportSoKhieuNaiToCao($tu_Ngay,$den_Ngay,$diaBanIdArray,$loai_baocao)
    {
        $donKhieuNaiToCao = DonThuTable::GetDonThuKhieuNaiTheoDiaBan($tu_Ngay,$den_Ngay,$diaBanIdArray);

        if("sokhieunai" == $loai_baocao) {

            $objWriter = MauSo::mauSoKhieuNai($donKhieuNaiToCao->khieuNai);

        }else{
            $objWriter = MauSo::mauSoToCao($donKhieuNaiToCao->toCao);
        }
	...
	/**************************************************
    Function Name	: GetBaoCaoDotXuat
    Description		:
    Argument		: None
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetBaoCaoDotXuat()
    {
        $result = BaoCaoDotXuat::GetBaoCaoDotXuatInfo();
        return $result;
    }

    /**************************************************
    Function Name	: StoreBaoCaoDotXuat
    Description		:
    Argument		: $request
    Creation Date	: 2016/12/19
    Author			: NamNh
    Reviewer		: PhucHM
     ***************************************************/
    public static function StoreBaoCaoDotXuat($request)
    {
        $result = BaoCaoDotXuat::StoreBaoCao($request);

        return $result;
    }

    /**************************************************
    Function Name	: XoaBaoCaoDotXuat
    Description		:
    Argument		: $request
    Creation Date	: 2016/12/19
    Author			: NamNh
    Reviewer		: PhucHM
     ***************************************************/
    public static function XoaBaoCaoDotXuat($request)
    {
        $result = BaoCaoDotXuat::XoaBaoCao($request);
        return $result;
    }

    /**************************************************
    Function Name	: page_ChinhSuaBaoCaoDotXuat
    Description		:
    Argument		: $request
    Creation Date	: 2016/12/19
    Author			: NamNh
    ...
    {
        $result = BaoCaoDotXuat::page_ChinhSuaBaoCaoDotXuat($baoCaoID);
        return $result;
    }
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function SuaBaoCaoDotXuat($request, $id)
    {
        BaoCaoDotXuat::SuaBaoCaoDotXuat($request, $id);
    }
	
	    /**************************************************
    Function Name	: upLoadFileDeXuatLenDonVi
    Description		:
    Argument		: None
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function upLoadFileDeXuatLenDonVi($donthuid,$request)
    {
        TheoDoiDonThuTable::fileBaoCaoLenDonVi($donthuid,$request);
    }
    /**************************************************
    Function Name	: upLoadFileDeXuatLenDonVi
    Description		:
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function upLoadFileDeXuatLenTW($donthuid,$request)
    {
        TheoDoiDonThuTable::fileBaoCaoLenTW($donthuid,$request);
    }
    /**************************************************
    Function Name	: upLoadFileDeXuatLenDonVi
    Description		:
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function upLoadFileYKienLanhDao($donthuid,$request)
    {
        TheoDoiDonThuTable::fileyKienLanhDao($donthuid,$request);
    }
    /**************************************************
    Function Name	: getDonThuCungCMT
    Description		:
    Argument		: None
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function getDonThuCungCMT ($value,$filed,$table)
    {
        $data = DonThuTable::getDonThuTheoCMT($value,$filed,$table);
        return $data;
    }
    /**************************************************
    Function Name	: upLoadFileDeXuatLenDonVi
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function dataChiTietDonThuNhieuNoi($value)
    {
        $result =array();
        $value = explode('*',$value);
        for($i = 0;$i<count($value);$i++)
        {
            $result[] = DonThuTable::getThongTinDonThuTheoId($value[$i]);
        }
    ...
    /**************************************************
    Function Name	: GetTongDonTrongKy
    Description		:
    Argument		: None
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetTongDonTheoKy($type1,$type2,$diaBanIdAllArray)
    {
        $data = array();

        if($type2 != DA_GQ_LAN_1 && $type2 != DA_GQ_LAN_2)
        {

            $data = DonThuTable::DataTongSoDonTheoKy($type1,$type2,$diaBanIdAllArray);
        }
        else
        {
            $data = DonThuTable::DonThuGiaiQuyetTheoLan($type1,$type2,$diaBanIdAllArray);
        }
    ...
    /**************************************************
    Function Name	: GetTongDonTrongKyTheoPhanLoai
    Description		:
    Argument		: None
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetTongDonTrongKyTheoPhanLoai($type1,$type2,$diaBanIdAllArray)
    {
        $field  = "";
        if($type1 == "LV")
        {

            $field = 'phanloaidonthu.linhvuc';
        }
        elseif($type1 == "LD")
        {
            $field = 'phanloaidonthu.loaidon';
        }
        else
        {
            $field = 'phanloaidonthu.diaban';
        }

        $data = DonThuTable::DonThuTrongKyTheoPhanLoai($field,$type2,$diaBanIdAllArray);
        return $data;
    }

    /**************************************************
    Function Name	: getDonThuDuocGiaoTheoIdPagination
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: KhanhTH
    ...
    {
        return PhanLoaiDonThuTable::getDonThuDuocGiaoTheoIdPagination($accountId);
    }
    /**************************************************
    Function Name	: GetDataNguoiXuLy
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetDataNguoiXuLy($diabanId,$donviId)
    {
        $arrayDiaBan = [$diabanId];
        $result = AccountInfoTable::GetAccountInfoTheoDonVi($donviId,$arrayDiaBan);

        return $result;
    }
    /**************************************************
    Function Name	: GetKetQuaGiaiQuyetDon
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetKetQuaGiaiQuyetDon($diaBanIdAllArray,$loaidon)
    {
        $data = DonThuTable::KetQuaGiaiQuyetDon($diaBanIdAllArray,$loaidon);

        return $data;
    }

    /**************************************************
    Function Name	: KetQuaGiaiQuyetDonTheoLoaiDon
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function KetQuaGiaiQuyetDonTheoLoaiDon($diaBanIdAllArray,$type,$loaidonId)
    {
        $results = DonThuTable::DanhSachKetQuaGiaiQuyetDon($diaBanIdAllArray,$type,$loaidonId);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function exportPhieuChuyenDon($donThuId,$accountId)
    {
        $thongTinDonThu = DonThuTable::getThongTinDonThuTheoId($donThuId);
        $phanLoaiDonThu = PhanLoaiDonThuTable::getNguoiXuLyDonThuTheoDonThuId($donThuId);
        $nguoiXuLyDonThu = AccountInfoTable::GetFullName($phanLoaiDonThu->nguoixuly);
        $objWriter = MauDon::PhieuChuyenDon($thongTinDonThu, $nguoiXuLyDonThu,$accountId);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function exportPhieuXuLy($donThuId,$accountId)
    {
        $thongTinDonThu = DonThuTable::getThongTinDonThuTheoId($donThuId);
        $phanLoaiDonThu = PhanLoaiDonThuTable::getNguoiXuLyDonThuTheoDonThuId($donThuId);
        $nguoiXuLyDonThu = AccountInfoTable::GetFullName($phanLoaiDonThu->nguoixuly);
        $objWriter = MauDon::PhieuXuLy($thongTinDonThu, $nguoiXuLyDonThu,$accountId);

        return $objWriter;
    }
    /**************************************************
    Function Name	: PostLichSuGiaoXuLy
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function PostLichSuGiaoXuLy($request)
    {
        $results = TheoDoiDonThuTable::InsertLichSuXuLy($request);

        return $results;
    }
    /**************************************************
    Function Name	: GetLichSuGiaoXuLy
    Description		:
    Argument		: $request
    Creation Date	: 2016/08/01
    Author			: Duongpd
    Reviewer		: PhucHM
     ***************************************************/
    public static function GetLichSuGiaoXuLy($donthuId)
    {
        $results = TheoDoiDonThuTable::GetLichSuXuLy($donthuId);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function ExportPhieuHuongDan($request,$accountId)
    {
        $thongTinDonThu = DonThuTable::getThongTinDonThuTheoId($request->donthuid);
        $phanLoaiDonThu = PhanLoaiDonThuTable::getNguoiXuLyDonThuTheoDonThuId($request->donthuid);
        $nguoiXuLyDonThu = AccountInfoTable::GetFullName($phanLoaiDonThu->nguoixuly);
        $objWriter = MauDon::PhieuHuongDan($thongTinDonThu, $nguoiXuLyDonThu,$accountId,$request);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function ExportVanBanTraLoi($donThuId,$accountId)
    {
        $thongTinDonThu = DonThuTable::getThongTinDonThuTheoId($donThuId);
        $phanLoaiDonThu = PhanLoaiDonThuTable::getNguoiXuLyDonThuTheoDonThuId($donThuId);
        $nguoiXuLyDonThu = AccountInfoTable::GetFullName($phanLoaiDonThu->nguoixuly);
        $objWriter = MauDon::VanBanTraLoi($thongTinDonThu, $nguoiXuLyDonThu,$accountId);
    ...
    Reviewer		: PhucHM
     ***************************************************/
    public static function PreviewVanBan($aryData){

        $thongTinDonThu = DonThuTable::getThongTinDonThuTheoId($aryData['donthuId']);
        $phanLoaiDonThu = PhanLoaiDonThuTable::getNguoiXuLyDonThuTheoDonThuId($aryData['donthuId']);
        $nguoiXuLyDonThu = AccountInfoTable::GetFullName($phanLoaiDonThu->nguoixuly);

        $result = MauDon::XemTruocVanBan($aryData,$thongTinDonThu,$nguoiXuLyDonThu);

        return $result;
    }

    public static function exportToWord($html){

        $result = MauDon::exportWord($html);
