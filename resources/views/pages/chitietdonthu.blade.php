                    ...
                    <div class="panel panel-default" >
                            ...
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-3" style="padding: 0">
                                        <input type="radio" id="choXuLyId" name="optradio" value="{{CHOXULY}}" {{($result['noidung'][0]->trangthaixuly == CHOXULY)?'checked':''}} disabled="disabled"> Chờ xử lý
                                    </div>
                                    <div class="col-xs-3" style="padding: 0">
                                        <input type="radio" id="dangXuLyId" name="optradio" value="{{DANGXULY}}" {{($result['noidung'][0]->trangthaixuly == DANGXULY)?'checked':''}} disabled="disabled"> Đang xử lý
                                    </div>
                                    <div class="col-xs-3" style="padding: 0">
                                        <input type="radio" id="daXuLyId" name="optradio" value="{{DAGIAIQUYET}}" {{($result['noidung'][0]->trangthaixuly == DAGIAIQUYET)?'checked':''}} disabled="disabled"> Đã xử lý
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-4 text-right" style="display:none">
                                <button class="btn btn-sm btn-info dropdown-toggle" data-toggle="dropdown">
                                    <span class="glyphicon glyphicon-print"></span>&nbsp; Kết chuyển ra mẫu <span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href="{{url('exportVanBanTraLoi/'.$result['noidung'][0]->donthuid)}}" ><span class="caret-left"></span> Văn bản trả lời công dân</a></li>
                                    <li><a href="{{url('exportPhieuXuLy/'.$result['noidung'][0]->donthuid)}}" ><span class="caret-left"></span> In phiếu xử lý đơn </a></li>
                                    <li><a href="{{url('exportPhieuHuongDan/'.$result['noidung'][0]->donthuid)}}" ><span class="caret-left"></span> In phiếu hướng dẫn công dân </a></li>
                                    <li><a href="{{url('exportPhieuChuyenDon/'.$result['noidung'][0]->donthuid)}}" ><span class="caret-left"></span> In phiếu chuyển đơn </a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <table class="table " >
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-xs-9">
                                            ...
                                            <div class="row" style="display:{{($result['noidung'][0]->nguondon == "dodan")?'none':''}}">
                                                <div class="col-xs-7" style="padding: 0">
                                        ...
                                        <div class="col-xs-2 col-md-3">
                                            <a href="#" class="thumbnail" style="height: 180px; width: 150px">
                                                <img src="{{(isset($result['noidung'][0]->image) && trim($result['noidung'][0]->image) != '' ) ? (url(FOLDERROOT.'/'.$result['noidung'][0]->filepath."/".$result['noidung'][0]->image)): (url('img/user.png')) }}" alt="{{($result['noidung'][0]->image != null)?'':'Chua co anh dai dien'}}" style="height: 100%; width: 100%">
                                            </a>
                                        </div>
                            ...
                            <tr id="danhSachDonLienQuan">
                                <td>
                                    @if(0!= count($thongTinDonCon))
                                        <div class="box-footer" style="display:{{(0!= count($thongTinDonCon))?'':'none'}}} " >
                                            <div class="row">
                                                <div class="col-xs-7" style="padding: 0">
                                            ...
                                            @foreach($thongTinDonCon as $donCon)
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-9" style="padding: 0">
                                                        <li>.
                                                            <a  href="{{url('chitietdonthu/'.$donCon->donthuid)}}">[{{$donCon->sothuly}}]</a>
                                                            ...
                                                            <label>Vào lúc <span style="color: #3377c7">{{date("H:i:s d/m/Y",strtotime($donCon->create_at))}}</span></label>
                                                        </li>
                                                    </div>
                                                </div>
                                                @endif
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-6" style="display: none"  id="divChuyenCanBo">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button type="button" class="btn btn-danger" id="huyChuyenCanBo" onclick="displayEdit(this.id);">Hủy</button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" style="display: none" id="divLuuHoSo">
                                        ...
                                        <div class="col-md-6"  >
                                            ...
                                            <div class="form-group" id="searchfield">
                                                <label>Hồ sơ </label>
                                                <input type="text" name="hoSoData" id="hoSoDataId" class="form-control">
                                                <input type="hidden" name="hoSoValueId" id="hoSoId" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary" id="luuHoSoId" onclick="displayEdit(this.id)">Lưu hồ sơ</button>
                                                <button type="button" class="btn btn-danger" id="huyLuuHoSo" onclick="displayEdit(this.id)">Hủy</button>
                                            </div>
                                        </div>
                                ...
                                <td>
                                    ...
                                    <div class="row" id="btnXuLy" >
                                        ...
                                        <ul class="list-inline">
                                            <li class="pull-right"><a  id="editCommentId" onclick="displayEdit(this.id);" href="#" class="link-blue text-md"><i class="fa fa-comments-o margin-r-5"></i> Ý kiến</a></li>
                                        </ul>
                                    ...
                                    <div class="row" style="display: none" id="commentId">
                                        <div class="form-horizontal">
                                            <div class="form-group margin-bottom-none">
                                                <div class="col-sm-10">
                                                    <input class="form-control input-sm" placeholder="y kien" id="commentInput" name="comment">
                                                </div>
                                                <div class="col-sm-2 ">

                                                    <ul class="list-inline">
                                                        <li class="pull-right"><button type="button" class="btn btn-danger pull-right btn-block btn-sm pull-right" id="huyCommentId" onclick="displayEdit(this.id);">Hủy</button></li>
                                                        <li class="pull-right"><button type="button" class="btn btn-success pull-right btn-block btn-sm pull-right" id="guiComment" onclick="displayEdit(this.id);" >Gửi</button></li>
                                                    </ul>
                            ...
                            <tr id="hienThiVanBan" style="display:none;">
                                <td id="preview_vanban" style="font-size: 15px !important;font-family: 'Helvetica Neue, Helvetica, Arial, sans-serif'">
