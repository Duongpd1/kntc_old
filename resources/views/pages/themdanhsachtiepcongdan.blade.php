                ...
                <form method="post" name="xacminh" action="{{url('submitthemdanhsachtiepcongdan')}}" enctype="multipart/form-data">
                    <div class="panel-body form-horizontal">
                        ...
                        <div class="form-group form-group-sm" id="formChuTri" >
                            ...
                            <div class="col-xs-4">
                                <input id="chuTri" name="chuTri" style="text-transform:uppercase" class="form-control" list="chuTriList" type="text" required>
                            ...
                            <div class="col-xs-3">
                                <input id="chucVuCT" name="chucVuCT" class="form-control" type="text" required>
                            </div>
                        </div>
