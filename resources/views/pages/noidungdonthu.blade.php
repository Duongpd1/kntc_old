                                ...
                                <td>
                                    <div class="panel-body form-horizontal">
                                        ...
                                        <div class="form-group form-group-sm" id="trangthaiId" style="display:{{($lanhDaoPermision == VANTHU)?'none':''}}">
                                            ...
                                            <div class="col-xs-4">
                                                <select id="trangthaixuly" name="trangthaixuly" class="form-control" >
                                                    ...
                                                    <option id="DAGIAIQUYET" value="{{DAGIAIQUYET}}" {{($data[0]->trangthaixuly == DAGIAIQUYET)?'selected':''}} style="display:{{($lanhDaoPermision == TIEPDAN)?'':'none'}}">Đã giải quyết</option>
                                        ...
                                        <div class="form-group form-group-sm"  style="display:{{($lanhDaoPermision == VANTHU)?'none':''}}">
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-xs-9">
                                                    <select id="nguondon" name="nguondon" class="form-control" onchange="showSelect(this);">
                                                        @if($data[0]->nguondon == "dodan")
                                                            <option  value="dodan" selected="selected">Do dân chuyển đến</option>
                                                            <option  value="donvi" >Do cơ quan đơn vị chuyển đến</option>
                                                        @else
                                                            <option  value="dodan" >Do dân chuyển đến</option>
                                                            <option  value="donvi" selected="selected">Do cơ quan đơn vị chuyển đến</option>
                                                        @endif
                                                    </select>

                                                    <div id="ttdv" class="panel panel-default" style="margin-top: 5px;{{($data[0]->nguondon == "donvi")?'':'display: none;'}}">
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-xs-9">
                                                    <select id="group" name="group" class="form-control" onchange="showSelect(this);">
                                                        <option  id="alone" value="0" {{($data[0]->songuoi == 0)?'selected':''}} >Cá nhân</option>
                                                        <option id="some" value="1" {{($data[0]->songuoi == 1)?'selected':''}}>Tập thể</option>
                                                    </select>

                                                    <div id="nhom" class="panel panel-default" style="margin-top: 5px;{{($data[0]->songuoi == 0)?'display: none;':''}}">
                                            ...
                                            <div id="donMotNguoi" style="{{($data[0]->songuoi == 0)?'':'display:none;'}}">
