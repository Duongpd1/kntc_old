            ...
            <div class="panel-body row" style="padding: 10px 0">
                <div class="col-xs-12 text-right">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{url('maudon/PhieuXuLyDon.doc')}}" download=""><span class="caret-left"></span> In phiếu xử lý đơn </a></li>
                        <li><a href="{{url('maudon/PhieuHuongDanDon.doc')}}" download=""><span class="caret-left"></span> In phiếu hướng dẫn công dân </a></li>
                        <li><a href="{{url('maudon/PhieuChuyenDon.doc')}}" download=""><span class="caret-left"></span> In phiếu chuyển đơn </a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="panel-body form-horizontal">
                <form method="post" name="xacminh" action="taodonthu" enctype="multipart/form-data">
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-2">
                            <input type="text" class="form-control"  id="sothuly" name="sothuly" value="{{$data}}" placeholder="Số/năm" >
                        </div>
                        <div class="col-xs-3">
                        ...
                        <div class="col-xs-3">
                            <div class="input-group input-group-sm date">
                                ...
                                <input class="form-control" type="text" id="ngaynhan" name="ngaynhan" value="{{$today}}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-9">
                            <select id="nguondon" name="nguondon" class="form-control" onchange="showSelect(this);">
                                <option  value="dodan">Do dân chuyển đến</option>
                                <option  value="donvi" >Do cơ quan đơn vị chuyển đến</option>
                            </select>
                    ...
                    <div class="form-group form-group-sm" id="divChuThe">
                        ...
                        <div class="col-xs-9">
                            <select id="group" name="group" class="form-control" onchange="showSelect(this);">
                                <option  id="alone" value="0">Cá nhân</option>
                                <option id="some" value="1">Tập thể</option>
                            </select>
                            <div id="nhom" class="panel panel-default" style="margin-top: 5px;display: none;">
                                <div class="panel-heading">Thông tin người viết đơn</div>
                                <table  class="table table-bordered table-hover" id="donnhieunguoi" style="display: none">
                                    <thead>
                                    <tr>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group form-group-sm">
                                        <label for="tenkntc" class="control-label col-xs-4">Tên chủ thể <span class="text-danger">(*)</span> </label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group form-group-sm" id="danhSachDTTrungNhauThem" style="display:none ">
                                        <div class="control-label col-xs-4"></div>
                                        <div class="col-xs-8">
                                            <a id="danhSachThem" onclick="DonThuTheoCMT(this);" style="cursor:pointer"><i>Danh sách đơn cùng số CMND/Hộ chiếu >></i></a>
                                        </div>
                                    ...
                                    <div class="form-group form-group-sm">
                                        ...
                                        <div class="col-xs-4">
                                            <input class="form-control" type="number" min="1" id="sdtThemId" name="sdtThem">
                                        </div>
                                    </div>
                    ...
                    <div id="donMotNguoi" >
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-9">
                                <input class="form-control" type="text" style="text-transform:uppercase" id="tennguoivietID" name="tennguoiviet" >
                            </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-xs-2">
                                <input name="cmt" type="text" maxlength="15" id="cmt" class="form-control" {{--required--}}>
                            </div>
                            <div class="col-xs-3">
                                <div class="input-group input-group-sm date" >
                                    <span class="input-group-addon">Ngày cấp</span>
                                    <input name="ngaycap" type="text" maxlength="10" placeholder="VD:01/01/2017" id="ngaycapID" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-4">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-addon">Nơi cấp</span>
                                    <input name="noicap" type="text" maxlength="50" value="C.A Tỉnh Phú Thọ" id="noicapID" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm" id="danhSachDTTrungNhau" style="display:none ">
                            <div class="control-label col-xs-3"></div>
                            <div class="col-xs-9">
                                <a id="theoNguoiViet" onclick="DonThuTheoCMT(this);" style="cursor:pointer"><i>Danh sách đơn cùng số CMND/Hộ chiếu >></i></a>
                            </div>
                    ...
                    <div class="form-group form-group-sm" id="divDoiTuong">
                        ...
                        <div class="col-xs-9">
                            <input name="doituong" type="text" id="dtbtc" class="form-control" style="text-transform:uppercase">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-xs-9">
                            <input class="form-control" type="text" style="text-transform:uppercase" id="nguoiLienQuanId" name="nguoiLienQuan" >
                        </div>
                    ...
                    <div class="form-group form-group-sm">
                        <div class="col-xs-9 col-xs-offset-3">
                            <input type="submit" class="btn btn-sm btn-success" value="Lưu" id="luu" name="luu" onclick="return CkeckInput();">
                            ...
                            <input type="button" class="btn btn-sm btn-danger" value="Hủy" id="huy" onclick="clickBtn(this);">
                        </div>
                    </div>
                </form>
            </div>
